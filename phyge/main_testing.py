...
if __name__ == "__main__":
    ...
    w2v = Storage.load_model('out/w2v', 'phyge', 'w2v')

    search_engine = SearchEngine(models=[lsi,lda,d2v,w2v])
    test_path = os.path.join(PhyVariables.testsDir, 'test_'+str(PhyVariables.queriesId))
    #run_search("Resources/pdf_articles_short.json", "Resources/answers.json", 1)
